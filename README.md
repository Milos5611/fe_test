...
4. open browser to localhost:3000 to view application

## Practical instructions

This is a challenge for web frontend development. It’s mostly implemented in react. If you don’t have any knowledge of react, please focus on the bitcoin code in src/bitcoin.js. 
This challenge is time boxed. Please don’t spend more than two hours and focus on the parts you think show best, what you are capable of.
The application is a simple product list and shopping cart. The following user stories should be supported:
1. As a user I want to see a list of products with prices.
2. As a user I want to add products to a shopping cart.
3. As a user I want to see the resulting total amount of money.
4. As a user I want to change the quantities for each product before adding to cart.
5. As a user I want to change the quantities for each product in the cart.

View the application code in the `/src` directory.

As you operate the application, notice some implementation errors. Please fix these errors and refactor the code based on what you would consider best practices.
